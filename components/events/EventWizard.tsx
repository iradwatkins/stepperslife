    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6">
              ...
              <div className="flex flex-col h-full">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 mt-0.5">{option.subtitle}</p>
                  </div>
                  <Icon className={`w-6 h-6 sm:w-8 sm:h-8 ${iconColorClasses[option.color]}`} />
                </div>
                
                <p className="text-xs sm:text-sm text-gray-600 mb-3">{option.description}</p>
      ...
      <div className="mt-8 space-y-4">
        <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
          <h4 className="font-semibold text-yellow-900 text-sm mb-1">📅 Save the Date</h4>
        ...
        <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
          <h4 className="font-semibold text-blue-900 text-sm mb-1">📍 Posted Events</h4>
        ...
        <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
          <h4 className="font-semibold text-green-900 text-sm mb-1">🎫 Ticketed Events</h4>
